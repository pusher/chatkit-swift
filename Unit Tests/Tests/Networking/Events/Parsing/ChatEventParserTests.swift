...
class ChatEventParserTests: XCTestCase {
    ...
    func testShouldCorrectlyParseValidInitialStateEvent() {
        ...
        mainContext.performAndWait {
            ...
            XCTAssertEqual(firstRoom.createdAt, Date(fromISO8601String: "2019-08-30T21:37:07Z"))
            XCTAssertEqual(firstRoom.updatedAt, Date(fromISO8601String: "2019-08-30T21:37:07Z"))
            ...
            XCTAssertEqual(secondRoom.createdAt, Date(fromISO8601String: "2019-09-06T09:29:15Z"))
            XCTAssertEqual(secondRoom.updatedAt, Date(fromISO8601String: "2019-09-06T09:29:25Z"))
            XCTAssertEqual(secondRoom.deletedAt, Date(fromISO8601String: "2019-09-06T09:29:35Z"))
    ...
    func testShouldUpdateExistingRoomWithTheSameIdentifier() {
        ...
        mainContext.performAndWait {
            ...
            XCTAssertEqual(oldRoom.createdAt, Date(fromISO8601String: "2019-08-30T21:37:07Z"))
            XCTAssertEqual(oldRoom.updatedAt, Date(fromISO8601String: "2019-08-30T21:37:07Z"))
            XCTAssertNil(oldRoom.deletedAt)
            XCTAssertEqual(oldRoom.members?.count, 0)
            XCTAssertEqual(oldRoom.messages?.count, 0)
            XCTAssertEqual(oldRoom.cursors?.count, 0)
    ...
    func testShouldSkipInvalidDeletedAtKey() {
        ...
        mainContext.performAndWait {
            ...
            XCTAssertEqual(room.createdAt, Date(fromISO8601String: "2019-09-06T09:29:15Z"))
            XCTAssertEqual(room.updatedAt, Date(fromISO8601String: "2019-09-06T09:29:25Z"))
    ...
    func testShouldSkipInvalidCustomData() {
        ...
        mainContext.performAndWait {
            ...
            XCTAssertEqual(room.createdAt, Date(fromISO8601String: "2019-09-06T09:29:15Z"))
            XCTAssertEqual(room.updatedAt, Date(fromISO8601String: "2019-09-06T09:29:25Z"))
            XCTAssertEqual(room.deletedAt, Date(fromISO8601String: "2019-09-06T09:29:35Z"))
            XCTAssertEqual(room.members?.count, 0)
            XCTAssertEqual(room.messages?.count, 0)
            XCTAssertEqual(room.cursors?.count, 0)
            XCTAssertEqual(room.typingMembers?.count, 0)
